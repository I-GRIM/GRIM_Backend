package com.example.bookgrim.config.jwt;
...
public class JwtTokenProvider {
    ...
    public JwtDto generateTokenDto(Authentication authentication) {
        ...
        return JwtDto.of(BEARER_TYPE,accessToken,refreshToken,accessTokenExpiresIn.getTime(),refreshTokenExpiresIn.getTime());
